...
xml.urlset "xmlns" => "http://www.sitemaps.org/schemas/sitemap/0.9" do
  ...
  sitemap.resources.each do |page|
      ...
      throw :next_page if page.url.start_with?('/documentation/images/')
      throw :next_page if page.url.start_with?('/documentation/javascripts/')
      throw :next_page if page.url.start_with?('/documentation/stylesheets/')
      throw :next_page if page.url.start_with?('/documentation/layouts/')
      throw :next_page if page.url.start_with?('/documentation/fonts/')
      throw :next_page if page.url.start_with?('/documentation/apple-touch-icon')
      ...
      xml.url do
        xml.loc 'https://www.codeship.io' + page.url   # TODO: possibly remove .html
